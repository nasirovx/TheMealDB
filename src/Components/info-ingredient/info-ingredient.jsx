            ...
            <div key={i} className={s.infoIngredients}>
                ...
                <div className={s.images}>
                    <div className={s.first_img}>
                        ...
                        <a href={elem.strYoutube}>Watch Video You Tube  <i class="fa-brands fa-youtube "></i></a> 
                    </div>
                    <div className={s.second_img}>
                        {
                            elem.strIngredient1 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient1)}  >
                        ...
                        {
                            elem.strIngredient2 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient2)}  >
                        ...
                        {
                            elem.strIngredient3 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient3)}  >
                        ...
                        {
                            elem.strIngredient4 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient4)}  >
                        ...
                        {
                            elem.strIngredient5 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient5)}  >
                        ...
                        {
                            elem.strIngredient6 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient6)}  >
                        ...
                        {
                            elem.strIngredient7 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient7)}  >
                        ...
                        {
                            elem.strIngredient8 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient8)}  >
                        ...
                        {
                            elem.strIngredient9 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient9)}  >
                        ...
                        }
                        {
                            elem.strIngredient10 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient10)} >
                        ...
                        }
                        {
                            elem.strIngredient11 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient11)} >
                        ...
                        }
                        {
                            elem.strIngredient12 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient12)} >
                        ...
                        }
                        {
                            elem.strIngredient13 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient13)} >
                        ...
                        }
                        {
                            elem.strIngredient14 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient14)} >
                        ...
                        }
                        {
                            elem.strIngredient15 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient15)} >
                        ...
                        }
                        {
                            elem.strIngredient16 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient16)} >
                        ...
                        }
                        {
                            elem.strIngredient17 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient17)} >
                        ...
                        }
                        {
                            elem.strIngredient18 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient18)} >
                        ...
                        }
                        {
                            elem.strIngredient19 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient19)} >
                        ...
                        }
                        {
                            elem.strIngredient20 ? (
                                <div className={s.second_item}  onClick={() => clickIngredient(elem.strIngredient20)} >
